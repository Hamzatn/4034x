...
# Recovery
TARGET_RECOVERY_FSTAB := device/tcl/4034x/rootdir/fstab.mt6580
TARGET_USE_CUSTOM_LUN_FILE_PATH := "/sys/class/android_usb/android0/f_mass_storage/lun%d/file"
TARGET_RECOVERY_PIXEL_FORMAT := ABGR_8888
TARGET_RECOVERY_DENSITY := hdpi
BOARD_CUSTOM_BOOTIMG_MK := device/tcl/4034x/mkbootimg.mk
...
# CMHW
BOARD_HARDWARE_CLASS := hardware/samsung/cmhw/ device/tcl/4034x/cmhw/

# RIL
BOARD_RIL_CLASS := ../../../device/tcl/4034x/ril/
BOARD_GLOBAL_CFLAGS += -DDISABLE_ASHMEM_TRACKING

# GPS
TARGET_SPECIFIC_HEADER_PATH := device/tcl/4034x/include

# Bluetooth
BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_BCM := true
BOARD_CUSTOM_BT_CONFIG := device/tcl/4034x/bluetooth/libbt_vndcfg.txt
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/tcl/4034x/bluetooth
